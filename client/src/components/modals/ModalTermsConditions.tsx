...
import { FormField, TextInput, Form as GForm, Box } from 'grommet'
...
export const ModalTermsConditions: React.FC<Props> = observer(({ onClose, setChecked }) => {
  ...
  return (
    <ModalContent>
      ...
      <Row style={{ justifyContent: 'space-between'}}>
        <CancelButton type='submit' onClick={() => {
          setChecked(false)
          onClose()}}
        >Cancel</CancelButton>
