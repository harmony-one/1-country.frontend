...
const config = {
  debug,
  contract: process.env.CONTRACT || '0x62848a59675Bf89cDA708d351DD2F12cF66994D7', // (debug ? '0x9BC52FBcCcde8cEADAEde51a25dBeD489b201e53' : '0x476e14D956dca898C33262aecC81407242f8431A'),
  ...
  tld: process.env.TLD || '_dev.1.country', // '.1.country',
  tldLink: process.env.TLD_LINK || '_dev.1.country', // '1.country',
  emojiType: {
    ONE_ABOVE: 0,
    FIRST_PRIZE: 1,
