...
export default {
  ...
  emailRevealPrice: process.env.EMAIL_REVEAL_PRICE_ETH || '2', // '200',
  phoneRevealPrice: process.env.PHONE_REVEAL_PRICE_ETH || '4', // '400',
  telegramRevealPrice: process.env.TELEGRAM_REVEAL_PRICE_ETH || '8', // '800',
